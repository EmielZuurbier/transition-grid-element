...
const stagger = document.querySelector('.js-stagger');
const easing = document.querySelector('.js-easing');
const attributes = document.querySelector('.js-attributes');
...
const setAttributes = () => {
	const formData = new FormData(attributes);
...
duration.value = 250;
stagger.value = 0;
easing.value = 'cubic-bezier(0.42, 0, 0.12, 0.97)';
...
attributes.addEventListener('input', setAttributes);
